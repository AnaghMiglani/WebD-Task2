...
app.get('/', (req, res) => {
  res.send(`
    ...
    <body>
      ...
      <br>
      <h3><a href="/login">Click here to log in with YouTube</a></h3>
      <br>
    </body>
    </html>
  `);
    ...
    if (isSubscribed) {
      ...
      return res.send(`
        ...
        <body>
          ...
          <br>
          <h3>Please <a href="https://www.youtube.com/@BYTE-mait">subscribe</a> and click <a href="/login">here</a> to relogin</h3>
          <br>
        </body>
        </html>
      `);
